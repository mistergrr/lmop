...
- [ ] Halia's Job Offer <**Stasia has forgotten about this**> ^eliminate-redbrands
	...
	- Location: [[Tresendar Manor History]]
...
- [x] [[Ruby Roo's Root]]
	...
	- **Rewards**
		...
		- [[Ruby Rax]]
		- [[RR Collar]]
- [x] Rescue Gundren ^rescue-gundren
	- Optional tasks:
		-  [x] Find Sildar's gear (+150gp)
	- Location: [[Cragmaw Castle]]
	- Turn in: [[Sildar Hallwinter|Sildar]]
	- **Rewards**:
		- 50gp each, 10% share of Mine's profits
		- Join [[The Lord's Alliance]]
		- +1 Phandalin #rep
...
- [x] The Banshee's Bargain ^banshee-bargain
	...
	- **Rewards**:
		...
		- Join [[The Harpers]]
		- +1 [[The Harpers]] #rep
- [x] [[Investigate Harbin]] ^spy-harbin
	- Tasks:
		- [x] Break into [[Harbin Wester]]'s home and bring any information that can be used against him.
	- Turn in: [[Halia Thornton]]
	- **Reward**:
		- 100gp
		- Join [[The Zhentarim]]
...
- [ ] Mirna's Heirloom ^mirna-heirloom
	...
	- Location: [[Thundertree|Thundertree]]
	- **Reward**: Gold and emerald necklace (200gp)
- [x] [[Orc Trouble]] ^eliminate-orcs
	...
	- **Reward**:
		...
		- 100gp
		- +2 Phandalin #rep
- [x] [[Old Owl Trouble]] ^old-owl-well
...
- [x] Wave Echo Cave ^wec
	...
	- **Rewards**:
		...
		- [[Iarno's Diary]]
		- [[Spider Staff]]
- [x] Kill the Spectator ^kill-spectator
	 - Task: Kill the spectator
	- Location: [[Forge of Spells]]
	- Turn in: [[Thariel]]
	- **Rewards**: 
		- Scorched chest
			- 1,100cp, 160sp, 50ep, 3 diamonds (100gp each)
			- Wooden pipe adorned with platinum filigree (150gp) — Not to be taken.
		- Cryptex
# Narrative Arc B | Penance
## Dorian's Penance
- [x] [[The Arcane Convergence]]
- Location: 
...
- **Rewards**:
	...
	- Gain "**Vampiric Touch**"
## Richtor's Penance
- [x] [[The Trial of Endurance]]
- Location: [[Endurance Hill]]
- **Rewards**:
	- Curse removed
...
- The [[The Angels' Tome]] is stolen or given to the messenger. Either way, whoever takes it gives it to the [[Iarno Albrek|Illusive Man]]. The messenger "rewards" the party with a "Fireball" to the face.
...
- [ ] [[Ritual of the Angels]] ^ritual-damned
	- [ ] Stop Glasstaff
		- In-battle skill challenge.
			- each of three can be destroyed per round.
			- three successful checks
	- [ ] Rescue Erynel

# Arc 2 Sidequests
## Gnomes Needed
- [x] Enlist the help of artificers to help restore the [[Forge of Spells]]. The gnomes in nearby [[Gnomengarde]] should have the expertise needed, and have a history of making strategic alliances with humans and dwarves.
	- **Quest giver**: [[Gundren Rockseeker]]
	- **Location**: [[Gnomengarde]]
	- **Reward**: Gemstones.
## Hire Rune Lord
- [ ] A runelord is needed to inscribe magic runes at the [[Forge of Spells]]
	- **Quest giver**: [[Gundren Rockseeker]]
	- **Reward**: magic items
## Gnomengarde Rescue
- [x] [[Gnomengarde Rescue]]
	- **Location**: [[Gnomengarde]]
	- **Rewards**: [[Clockwork Amulet]], [[Pole of Collapsing]], and [[Wand of Pyrotechnics]] 
## Paint Supplies
- [ ] Ronaldo the Painter needs ingredients for his paints.
	- **Cochineal** – A crushed scale insect harvested from oak trees. Produced a deep crimson. Very costly and associated with royalty or the church.
	- 3x Giant boars, 9 boars
	- **Quest Giver**: [[Ronaldo of Triboar]]
	- **Reward** A charcoal drawing or interior décor advice magic NFT. and 80 sp.
## Phandalin Vandals
[[Phandalin Vandals]]
- [x] Find out who has been vandalising [[Richtor Helmsley III|Richtor's]] statue
	- **Rewards**
		- A gold star worth 20 gp.
## Umbrage Hill
- [x] Rescue [[Milly Milner]] from the manticores
	- 3 manticores. Willing to bargain in exchange for human meat or 25 gp in treasure.
