...
- **Hands**. Minions
	- AC 12; HP 2; **Immune**: Necrotic, poison, charm, fright
	- **Slam (GA)**: x+2; 2x necrotic
	- **Grab (GA)**. DC x+11 DEX save; grappled.
- **Dumbwaiter**. Fits two medium or one large creature. Can be used to access upper floors and roof. Platform currently at roof. Operated by ropes and pulleys.
	- Raise speed: 2 rounds per floor.
	- Lower speed: 1 rounds per floor.
### Basement
![[Frankstein-Basement.jpg]]
(Illustrated by Bernie Wrightson)
>Ice tub with partially assembled female **body**. Bunsen burners. **Shelves** with pickled body parts and organs.
...
>King sized bed. **Shelf** of personal items.

- **Shelf**. Blonde woman's head in a pickle jar, wedding photo of young Vic and woman head (with body attached), 
	- [[Potion of Comprehension]]
### Roof
...
- **Vic Frankstein** [Noble](https://5e.tools/bestiary.html#noble_xmm)
	...
	- **Parry (RA)**. +2 AC.
- **The Creature**. [Flesh golem](https://5e.tools/bestiary.html#flesh%20golem_xmm) with lightning rod in it.
- **Hazard**. Lightning strikes the creature on initiative 20. 5ft radius; DC 13 DEX save; 16 (3d10) lightning or half.
# Negotiations
[[Negotiations]]
## Clerval
Patience | Interest
