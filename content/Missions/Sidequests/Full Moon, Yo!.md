...
- The monks can provide one case each of silvered **ammunition** for free.
- The [[Uthgardt]] only speak **Bothii**
- **Rituals** at stone henges. One is nearby. It **empowers** them.
- It's a **clear** night
- Raiders **transform** on death.
- "Don't get bit".
# Background
...
- **Wave 3**: 4 [[Werewolf]] + 4 Dire Wolves (CR 16)
### Med
...
- 4 dire wolves
- 1 [[Werewolf]]
- **Stonehenge Pillar (x4)**. AC/DC 15, HP 32; *Immune*: psychic, poison *Resist*: slashing, piercing; 
	- **Empowered blows** Uthgardt pair deal extra 4 (1d8) lunar damage per pillar active.
	- **Alt 2**: Each pillar deals 2d8 to werewolves when destroyed.
